...
class StoriesAdapter(private val context: Context, private val users: ArrayList<UserModel>, private val storySelectListener: StorySelectListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
